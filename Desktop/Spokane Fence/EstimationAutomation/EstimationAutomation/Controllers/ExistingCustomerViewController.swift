...
class ExistingCustomerViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, SFSafariViewControllerDelegate {
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            let alert = UIAlertController(title: "QuickBooks Online Message", message: "Are you sure you want to delete this customer? Their data will also be removed from your QuickBoooks account.", preferredStyle: .alert)
